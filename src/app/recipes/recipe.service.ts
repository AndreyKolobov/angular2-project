...
export class RecipeService {
  ...
  storeData(){
    ...
    return this.httpService.put('https://recipebook-761fc.firebaseio.com/recipes.json', body, {headers: headers});
  }

  fetchData(){
    return this.httpService.get('https://recipebook-761fc.firebaseio.com/recipes.json')
